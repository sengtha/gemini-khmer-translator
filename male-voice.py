...
def run():
    ...
    print("Step 3: Generating Custom AI Studio Voice (Erinome)...")
    
    # Using your exact AI Studio prompt configuration
...
# Director's note
Style: High energy, punchy consonants, elongated vowels on excitement words. Pace: Natural. Accent: Neutral.
